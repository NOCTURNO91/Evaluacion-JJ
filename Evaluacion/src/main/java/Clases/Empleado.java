...
public class Empleado {
    ...
    public double calcularSalario(){
        int salarioVentas= numeroVentasMensuales* this.valorComision;
        int salarioTotal= salarioVentas + this.salario;
        double salarioDeducion= salarioTotal * this.deducciones;
        double salarioNeto = salarioTotal-salarioDeducion;
